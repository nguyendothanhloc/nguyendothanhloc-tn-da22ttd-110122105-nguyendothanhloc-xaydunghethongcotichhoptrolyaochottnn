            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:flex">
                    ...
                    @if(Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('enrollments.admin')" :active="request()->routeIs('enrollments.admin')">
                            Đăng ký
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('enrollments.admin')" :active="request()->routeIs('enrollments.admin')">
                    Đăng ký
                </x-responsive-nav-link>
